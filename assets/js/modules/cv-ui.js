/**
 * ==================================================================================
 * CV UI MODULE — assets/js/modules/cv-ui.js
 * ==================================================================================
    ...
    function renderAutomationSettings() {
        ...
        if (Array.isArray(humanR.rules) && humanR.rules.length > 0) {
            humanRulesHtml = humanR.rules.map((r, i) => {
                ...
                const actionLabels = { on: 'Nyalakan', off: 'Matikan', speed_high: 'Kipas 75%', speed_mid: 'Kipas 50%', speed_low: 'Kipas 25%' };
                const onTrueTxt  = actionLabels[r.onTrue]  || '';
                const onFalseTxt = actionLabels[r.onFalse] || '';
