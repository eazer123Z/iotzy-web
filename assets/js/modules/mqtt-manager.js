/* 
 * ==================================================================================
 * MQTT MANAGER MODULE — assets/js/modules/mqtt-manager.js
 * ==================================================================================
 * Mengelola koneksi, publikasi, dan langganan pesan MQTT.
...
async function connectMQTT() {
  try {
    ...
    // Browser hanya bisa WebSockets — konversi port TCP ke WebSocket
