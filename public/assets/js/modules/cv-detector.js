/**
 * ==================================================================================
 * CV DETECTOR MODULE (Computer Vision)
 * ==================================================================================
 * Menggunakan TensorFlow.js dan model COCO-SSD untuk mendeteksi objek secara real-time.
 * Fokus utama adalah deteksi manusia (Presence) untuk memicu otomasi rumah pintar.
 */
class CVDetector {
    constructor() {
        this.model             = null;
