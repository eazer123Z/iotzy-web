 ...
 * ───
 * Abstraksi data pengguna dan perangkat. Mengelola query pengambilan 
 * informasi user, daftar perangkat IoT, riwayat sensor, dan log aktivitas.
 */
    ...
    try {
        $stmt = $db->prepare(
            "SELECT id, user_id, device_key, name, icon, type,
                    ...
                    latest_state, last_seen, last_state_changed
             FROM devices
